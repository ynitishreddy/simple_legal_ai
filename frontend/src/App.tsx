    ...
    <div className="min-h-screen bg-[#090d16] text-[#e2e8f0] flex flex-col">
      ...
      <main className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 p-6 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto space-y-2 pr-1">
              {cases.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-slate-500 text-xs py-8">
                  <span>No court cases ingested.</span>
                  <span>Use upload portal to add records.</span>
                </div>
              ) : (
                cases.map((c) => (
                  <button
        ...
        <div className="lg:col-span-9 flex flex-col space-y-6 h-full">
          ...
          {/* PANEL B: Case Ingestion Portal */}
          <section className="bg-slate-900/50 backdrop-blur-md border border-slate-800/80 rounded-xl p-4">
            <div className="flex items-center space-x-2 pb-3 mb-3 border-b border-slate-800/80">
            ...
            <form onSubmit={handleUploadSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-2 flex flex-col space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs bg-slate-950 border border-slate-800 focus:border-indigo-500/50 rounded p-2 text-slate-200 outline-none"
                    />
                  </div>
                  <div>
                    <label className="block text-[10px] uppercase font-semibold text-slate-400 mb-1">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full text-xs bg-slate-950 border border-slate-800 focus:border-indigo-500/50 rounded p-2 text-slate-200 outline-none resize-none font-mono"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <div
                  ...
                  className={`flex-1 border-2 border-dashed rounded-lg flex flex-col items-center justify-center p-4 text-center cursor-pointer transition-all duration-200 ${
                    dragActive
                ...
                <button
                  ...
                  className="w-full mt-3 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs py-2 px-4 rounded transition duration-200 disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center space-x-1.5"
                >
                  {isUploading ? (
                    <>
            ...
            <div className="flex justify-between items-center pb-3 mb-4 border-b border-slate-800/80">
              ...
              {timeline?.case_info && (
                <span className="text-xs text-slate-400 italic">
                  {timeline.case_info.citation} ({timeline.case_info.court})
                </span>
              )}
            </div>
